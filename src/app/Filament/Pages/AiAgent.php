...
class AiAgent extends Page
{
    ...
    private function ensureDefaultSettings(): void
    {
        ...
        $data = [
            ...
            'PromptSistem' => 'Anda adalah AI Agent customer service CareDesk. Jawab dalam Bahasa Indonesia yang sopan, singkat, jelas, dan jangan membuat janji teknis yang belum dipastikan.',
            'TemplateDiluarJamKerja' => 'Terima kasih sudah menghubungi CareDesk. Saat ini kami berada di luar jam operasional. Pesan Bapak/Ibu sudah kami terima dan akan kami tindak lanjuti pada jam kerja berikutnya.',
            'TemplateHariLibur' => $this->defaultHolidayTemplate(),
            'TemplateJamKerjaSapaan' => 'Halo, terima kasih sudah menghubungi CareDesk. Saya bantu catat terlebih dahulu ya. Silakan jelaskan kendala yang sedang dialami, nanti tim customer service kami akan melanjutkan penanganannya.',
    ...
    {
        return 'Halo {nama_user}, ada chat WhatsApp dari {nama_instansi} yang belum dibalas selama {menit_menunggu} menit. Kontak: {nama_kontak} ({nomor_whatsapp}). Pesan terakhir: {pesan_terakhir}. Silakan cek CareDesk: {url_admin}';
    }
