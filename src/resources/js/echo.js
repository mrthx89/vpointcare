...
window.Echo = new Echo({
    ...
    wsPort: isSecure ? (import.meta.env.VITE_REVERB_PORT ?? 8080) : (import.meta.env.VITE_REVERB_PORT ?? 8080),
    wssPort: isSecure ? (import.meta.env.VITE_REVERB_PORT ?? 8080) : (import.meta.env.VITE_REVERB_PORT ?? 8080),
    forceTLS: isSecure,
