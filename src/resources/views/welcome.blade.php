...
<head>
    ...
    <title>{{ config('app.name', 'VPoint Care') }}</title>

    <!-- Primary Meta Tags -->
    <meta name="title" content="{{ config('app.name', 'VPoint Care') }}">
    <meta name="description"
        content="Sistem Informasi Manajemen Terpadu VPoint Care. Solusi cerdas untuk mengelola dan memonitor pelayanan dengan cepat dan responsif.">

    <!-- Open Graph / Facebook / WhatsApp -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="{{ url('/') }}">
    <meta property="og:title" content="{{ config('app.name', 'VPoint Care') }}">
    <meta property="og:description"
        content="Sistem Informasi Manajemen Terpadu VPoint Care. Solusi cerdas untuk mengelola dan memonitor pelayanan dengan cepat dan responsif.">
    <meta property="og:image" content="{{ asset('seo-banner.jpg') }}">
    ...
    <meta property="twitter:title" content="{{ config('app.name', 'VPoint Care') }}">
    <meta property="twitter:description"
        content="Sistem Informasi Manajemen Terpadu VPoint Care. Solusi cerdas untuk mengelola dan memonitor pelayanan dengan cepat dan responsif.">
    <meta property="twitter:image" content="{{ asset('seo-banner.jpg') }}">
    <!-- Fonts -->
...
<body
    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            ...
            <div
                class="bg-gray-50 dark:bg-[#161615] flex items-center justify-center p-12 relative lg:-ml-px -mb-px lg:mb-0 rounded-t-lg lg:rounded-t-none lg:rounded-r-lg aspect-[335/364] lg:aspect-auto w-full lg:w-[438px] shrink-0 overflow-hidden">
                {{-- VPoint Care Logo --}}
                <img src="{{ asset('res/logo_secondary.svg') }}" alt="VPoint Care Logo"
                    class="w-full max-w-[250px] transition-all translate-y-0 opacity-100 duration-750 starting:opacity-0 motion-safe:starting:translate-y-6">
                <svg class="hidden w-full text-[#F53003] dark:text-[#F61500] transition-all translate-y-0 opacity-100 max-w-none duration-750 starting:opacity-0 motion-safe:starting:translate-y-6"
                ...
                {{-- 13 --}}
                <svg class="hidden w-[438px] max-w-none relative -mt-[6.6rem] -ml-8 lg:ml-0 [--stroke-color:#1B1B18] dark:[--stroke-color:#FF750F]"
