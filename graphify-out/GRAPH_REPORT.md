...
## Corpus Check
- 337 files · ~271,157 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6957 nodes · 20402 edges · 301 communities (274 shown, 27 thin omitted)
...
- View Chat Session Blade Module
- Proposal Module
...
## Communities (301 total, 27 thin omitted)

### Community 0 - "Code Editor Module"
Cohesion: 0.01
Nodes (230): aa(), activeForPoint(), addBlock(), addChild(), addEventListener(), addGaps(), addLeafElement(), addLineDeco() (+222 more)
...
Cohesion: 0.01
Nodes (103): abutsStart(), Ac(), af(), al(), beforeDraw(), Bh(), br(), _c() (+95 more)

### Community 3 - "Rich Editor Module"
Cohesion: 0.01
Nodes (134): [g](), accepts(), addExtensions(), addGlobalAttributes(), addHackNode(), addTextblockHacks(), an(), applyAspectRatio() (+126 more)

### Community 4 - "Code Editor Module"
Cohesion: 0.02
Nodes (164): accept(), active(), add(), addChunk(), addInfoPane(), addInner(), addToSet(), adjust() (+156 more)

### Community 5 - "Code Editor Module"
Cohesion: 0.02
Nodes (149): ad(), addChanges(), addElement(), Ag(), applyChanges(), applyTransaction(), asSingle(), balanced() (+141 more)

### Community 6 - "Chart Module"
Cohesion: 0.02
Nodes (91): Em(), addControllers(), addEventListener(), addPlugins(), addScales(), afterDraw(), al(), as() (+83 more)

### Community 7 - "Chart Module"
Cohesion: 0.03
Nodes (113): after(), am(), as(), before(), bm(), buildTicks(), Cm(), contains() (+105 more)

### Community 8 - "Code Editor Module"
Cohesion: 0.03
Nodes (111): addBlockWidget(), addBreak(), addComposition(), addDelimiter(), addInlineWidget(), addLine(), addLineStart(), addLineStartIfNotCovered() (+103 more)

### Community 9 - "Code Editor Module"
Cohesion: 0.04
Nodes (97): addCompletion(), addCompletions(), addNamespace(), addNamespaceObject(), ah(), AP(), atLastNode(), c$() (+89 more)

### Community 10 - "Markdown Editor Module"
Cohesion: 0.05
Nodes (88): ad(), af(), ai(), ao(), Ba(), bo(), Cc(), cd() (+80 more)

### Community 11 - "Chart Module"
Cohesion: 0.03
Nodes (96): afterAutoSkip(), applyStack(), Ar(), aspectRatio(), At(), bi(), buildLookupTable(), _calculateBarIndexPixels() (+88 more)

### Community 12 - "Rich Editor Module"
Cohesion: 0.07
Nodes (93): ac(), addNodeMark(), after(), am(), ap(), Ax(), before(), bm() (+85 more)
...
Cohesion: 0.03
Nodes (83): addActive(), Ar(), aS(), at(), b1(), be(), boundChange(), combine() (+75 more)
...
Cohesion: 0.07
Nodes (71): Pr(), _a(), Ac(), Ae(), ar(), as(), bc(), bf() (+63 more)
...
Cohesion: 0.07
Nodes (65): addAll(), addDOM(), addElement(), addElementByRule(), addToSet(), allowedMarks(), allowsMarkType(), as() (+57 more)
...
Cohesion: 0.05
Nodes (62): readOnly(), Aa(), active(), afterBuildTicks(), afterCalculateLabelRotation(), afterDataLimits(), afterFit(), afterSetDimensions() (+54 more)

### Community 26 - "Chart Module"
Cohesion: 0.07
Nodes (60): adjustHitBoxes(), At(), bh(), bi(), calculateLabelRotation(), _calculatePadding(), clear(), _computeLabelArea() (+52 more)
...
Cohesion: 0.05
Nodes (58): $a(), addBox(), addControllers(), addElements(), addEventListener(), addPlugins(), addScales(), an() (+50 more)

### Community 30 - "Chart Module"
Cohesion: 0.05
Nodes (57): ad(), au(), Ba(), bd(), beforeLayout(), Ca(), cd(), data() (+49 more)

### Community 31 - "Markdown Editor Module"
Cohesion: 0.16
Nodes (56): at(), Be(), Cr(), Ct(), de(), df(), dr(), dt() (+48 more)
...
Cohesion: 0.07
Nodes (51): _0(), addActions(), advance(), advanceFully(), advanceStack(), allActions(), AZ(), break() (+43 more)

### Community 34 - "Chart Module"
Cohesion: 0.06
Nodes (51): Bc(), ae(), apply(), ba(), bl(), Bt(), Ce(), chartOptionScopes() (+43 more)
...
Cohesion: 0.06
Nodes (46): acceptToken(), allows(), an(), AQ(), bd(), Cg(), clearDelayedAndroidKey(), $d() (+38 more)
...
Cohesion: 0.07
Nodes (46): afterAutoSkip(), Ar(), buildLookupTable(), _calculateBarIndexPixels(), _calculateBarValuePixels(), _computeGridLineItems(), countVisibleElements(), Ct() (+38 more)
...
Cohesion: 0.06
Nodes (44): ah(), average(), beforeDatasetsDraw(), bu(), Da(), dataset(), ee(), En() (+36 more)

### Community 44 - "Register Module"
Cohesion: 0.07
Nodes (16): Filament\Actions\Action, Filament\Auth\Http\Responses\Contracts\LoginResponse, Filament\Auth\Http\Responses\Contracts\RegistrationResponse, Filament\Auth\Pages\Login, Filament\Auth\Pages\Register, Filament\Models\Contracts\FilamentUser, Filament\Panel, Filament\PanelProvider (+8 more)
...
Cohesion: 0.07
Nodes (43): add(), ai(), Bf(), bn(), _computeLabelSizes(), createResolver(), _d(), dd() (+35 more)
...
Cohesion: 0.07
Nodes (41): nh(), bo(), buildOrUpdateScales(), ch(), D(), diff(), eh(), endOf() (+33 more)

### Community 50 - "Chart Module"
Cohesion: 0.07
Nodes (40): alpha(), Ao(), Bo(), cl(), cs(), daysInYear(), dh(), Ec() (+32 more)

### Community 51 - "Chart Module"
Cohesion: 0.07
Nodes (40): an(), Ao(), applyStack(), beforeDatasetDraw(), beforeDatasetsDraw(), beforeDraw(), co(), dc() (+32 more)

### Community 52 - "Code Editor Module"
Cohesion: 0.07
Nodes (39): bidiSpans(), checkHover(), coordsAtPos(), dP(), Ef(), elementAtHeight(), find(), forRange() (+31 more)

### Community 53 - "Rich Editor Module"
Cohesion: 0.07
Nodes (38): bt(), connectSelection(), deselectNode(), disconnectSelection(), ey(), flush(), flushSoon(), forceFlush() (+30 more)

### Community 54 - "Chart Module"
Cohesion: 0.07
Nodes (38): _a(), acquireContext(), alpha(), color(), darken(), desaturate(), Dr(), Ee() (+30 more)

### Community 55 - "Date Range Component Module"
Cohesion: 0.13
Nodes (38): a(), aggregate(), append(), _appendChar(), _appendCharRaw(), _appendEager(), _appendPlaceholder(), appendTail() (+30 more)
...
Cohesion: 0.07
Nodes (36): Tl(), ab(), cc(), check(), checkAttrs(), dc(), Dn(), done() (+28 more)
...
Cohesion: 0.08
Nodes (36): average(), cc(), dataset(), En(), first(), getCenterPoint(), _getLegendItemAt(), getProps() (+28 more)
...
Cohesion: 0.12
Nodes (33): al(), An(), Bt(), co(), Dn(), En(), Eo(), es() (+25 more)

### Community 67 - "Rich Editor Module"
Cohesion: 0.09
Nodes (33): addMaps(), addStep(), addTransform(), appendMap(), appendMapping(), appendMappingInverted(), apply(), applyInner() (+25 more)
...
Cohesion: 0.08
Nodes (31): apply(), _cachedScopes(), Cc(), chartOptionScopes(), ci(), constructor(), describe(), dg() (+23 more)

### Community 71 - "Chart Module"
Cohesion: 0.09
Nodes (31): aa(), add(), br(), ca(), ci(), da(), _getAnims(), getPadding() (+23 more)
...
### Community 73 - "Rich Editor Module"
Cohesion: 0.08
Nodes (30): bd(), closest(), computeWrapping(), dd(), defaultType(), descAt(), domAfterPos(), domFromPos() (+22 more)

### Community 74 - "Chart Module"
Cohesion: 0.09
Nodes (30): afterDatasetsUpdate(), datasetElementScopeKeys(), generateLabels(), getDatasetMeta(), getDataVisibility(), _getLegendItemAt(), getMaxBorderWidth(), getStyle() (+22 more)
...
Cohesion: 0.11
Nodes (26): buildTicks(), calculateCircumference(), _circumference(), _computeAngle(), _computeLabelItems(), _computeLabelSizes(), computeTickLimit(), Do() (+18 more)
...
### Community 88 - "Markdown Editor Module"
Cohesion: 0.13
Nodes (24): Aa(), cf(), da(), ef(), fa(), ga(), Gr(), Jc() (+16 more)

### Community 89 - "Rich Editor Module"
Cohesion: 0.12
Nodes (25): Ad(), append(), cut(), es(), fromArray(), fs(), Gt(), ic() (+17 more)

### Community 90 - "Rich Editor Module"
Cohesion: 0.11
Nodes (25): ak(), allowsMarks(), Ba(), checkContent(), child(), computeAttrs(), createChecked(), e0() (+17 more)

### Community 91 - "Date Range Component Module"
Cohesion: 0.17
Nodes (24): alignCursor(), _applyDispatch(), _blockStartPos(), c(), doCommit(), doDispatch(), e(), extractInput() (+16 more)
...
Cohesion: 0.18
Nodes (8): Filament\Auth\Http\Responses\Contracts\LogoutResponse, Illuminate\Http\RedirectResponse, Illuminate\Routing\Controller, Illuminate\Support\ServiceProvider, Livewire\Features\SupportRedirects\Redirector, ExternalAuthController, LandingLogoutResponse, AppServiceProvider

### Community 95 - "Rich Editor Module"
Cohesion: 0.11
Nodes (21): bc(), domAtPos(), element(), fm(), gg(), Gs(), Ih(), im() (+13 more)
...
### Community 138 - "Database Schema Wacs Module"
Cohesion: 0.31
...
Cohesion: 0.22
Nodes (10): constructor(), Ct(), extractPatternOptions(), Ie(), Kn(), _onChange(), optionsIsChanged(), r() (+2 more)
...
### Community 150 - "File Upload Module"
Cohesion: 0.25
Nodes (9): Bp(), Cp(), Dp(), lm(), Op(), sa(), Ye(), yl() (+1 more)

### Community 152 - "Spec Module"
Cohesion: 0.25
...
Cohesion: 0.29
Nodes (8): Gt(), Jo(), Le(), on(), or(), sn(), xa(), zf()
...
### Community 178 - "2026 04 27 000001 Create Vpoint Care Schema Module"
Cohesion: 0.60
...
- **What is the exact relationship between `VPoint Care SEO Banner (PNG)` and `Open Graph / Social Sharing Preview Image (1200x630)`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `o()` connect `Rich Editor Module` to `Code Editor Module`, `File Upload Module`, `Rich Editor Module`, `Code Editor Module`, `Code Editor Module`, `Chart Module`, `Chart Module`, `Code Editor Module`, `Code Editor Module`, `Chart Module`, `Chart Module`, `Rich Editor Module`, `Chart Module`, `Code Editor Module`, `Date Range Component Module`, `Chart Module`, `Tables Module`, `Chart Module`, `Chart Module`, `Chart Module`, `Echo Module`, `Support Module`, `Chart Module`, `Chart Module`, `Code Editor Module`, `Chart Module`, `Code Editor Module`, `Rich Editor Module`, `File Upload Module`, `Select Module`, `Chart Module`, `Chart Module`, `Chart Module`, `Chart Module`, `Code Editor Module`, `Chart Module`, `Date Range Component Module`, `Rich Editor Module`, `Select Module`, `Chart Module`, `Select Module`, `Select Module`, `Rich Editor Module`, `Chart Module`, `Chart Module`, `Rich Editor Module`, `Support Module`, `Echo Module`, `Support Module`, `Rich Editor Module`, `Date Range Component Module`, `App Module`, `Echo Module`, `Select Module`, `Select Module`, `Select Module`, `Select Module`, `Chart Module`, `Chart Module`, `Select Module`, `Select Module`, `Select Module`?**
  _High betweenness centrality (0.132) - this node is a cross-community bridge._
- **Why does `h()` connect `Rich Editor Module` to `Chart Module`, `Code Editor Module`, `Code Editor Module`, `Chart Module`, `Chart Module`, `Code Editor Module`, `Code Editor Module`, `Markdown Editor Module`, `Chart Module`, `Rich Editor Module`, `Chart Module`, `Code Editor Module`, `Chart Module`, `Chart Module`, `Chart Module`, `Chart Module`, `Support Module`, `Chart Module`, `Chart Module`, `Markdown Editor Module`, `Chart Module`, `Chart Module`, `Markdown Editor Module`, `Code Editor Module`, `Rich Editor Module`, `Chart Module`, `Select Module`, `Chart Module`, `Markdown Editor Module`, `Chart Module`, `Chart Module`, `Chart Module`, `Chart Module`, `Select Module`, `Chart Module`, `Rich Editor Module`, `Support Module`, `Chart Module`, `Rich Editor Module`, `Support Module`, `Chart Module`, `Date Range Component Module`, `Chart Module`?**
