...
## Addendum 2026-06-28 — Integrasi Desk Assistant Internal

### Scope Tambahan
- Desk Assistant dapat membuat `TAiDraftPengetahuan` dari jawaban AI internal melalui tombol draft pada bubble assistant.
...
### Acceptance Criteria
- User dengan `knowledge.manage` melihat tombol buat draft pada jawaban Desk Assistant.
