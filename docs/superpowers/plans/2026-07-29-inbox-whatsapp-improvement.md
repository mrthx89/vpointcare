...
- [x] **Step 1: Buat unit test dengan payload konkret**
...
- [x] **Step 2: Jalankan test untuk membuktikan kondisi merah**
...
- [x] **Step 3: Catat aturan candidate extraction dalam test data provider**

Tambahkan data provider yang memverifikasi daftar sumber berikut secara eksplisit: dataUrl, data_url, media.dataUrl, media.data_url, base64, media.base64, media.data, media.file, file.data, file.base64, data, file, dan body. Root data/file/body hanya valid bila payload memiliki hasMedia=true, MIME media, filename media, atau JenisPesan bukan Teks. Nested media.* dan data URI sudah menjadi konteks media. Sticker WebP mengikuti kategori image dan harus memiliki opsi download seperti media lain.

- [x] **Step 4: Jalankan kembali test dan simpan output merah sebagai gate Task 2**
...
- [x] **Step 1: Buat class final dan signature public yang tetap**
...
- [x] **Step 2: Implementasikan candidate() private dengan urutan deterministik**
...
Gunakan Arr::get(). Terima string non-kosong. Untuk data/file/body root, wajibkan konteks media. Jangan lakukan array_walk_recursive() terhadap seluruh payload. Sticker terdeteksi dari key yang sama dengan image.

- [x] **Step 3: Implementasikan inspectPayload() tanpa decode binary**
...
- [x] **Step 4: Implementasikan fromPayloadJson() dan fromDataUri() dengan strict decode**
...
- [x] **Step 5: Jalankan unit test parser**
...
- [x] **Step 1: Tambahkan test MIME precedence dan signature**
...
- [x] **Step 2: Tambahkan test filename dan inline security**
...
- [x] **Step 3: Implementasikan MIME hierarchy**
...
- [x] **Step 4: Implementasikan filename dan category**
...
- [x] **Step 5: Jalankan seluruh unit test helper**
...
- [x] **Step 1: Buat test harness SQLite dan user auth in-memory**
...
- [x] **Step 2: Tambahkan test embedded fallback dan download**
...
- [x] **Step 3: Tambahkan test URL gagal lalu fallback payload**
...
- [x] **Step 4: Tambahkan failure/security tests**
...
- [x] **Step 5: Jalankan test untuk membuktikan kondisi merah**
...
- [x] **Step 1: Perluas query row tanpa mengubah route**
...
- [x] **Step 2: Implementasikan urutan sumber media**
...
- [x] **Step 3: Satukan header dalam mediaResponse()**
...
- [x] **Step 4: Sanitasi failure response dan log**
...
- [x] **Step 5: Hapus logika yang sudah dipusatkan**
...
- [x] **Step 6: Jalankan test controller hingga hijau**
...
- [x] **Step 1: Buat helper schema dan seed user/chat di test**
...
- [x] **Step 2: Tambahkan test default dan validasi mode**
...
- [x] **Step 3: Tambahkan fixture grup yang sengaja memisahkan chat dan participant**
...
- [x] **Step 4: Tambahkan assertion proyeksi grup dan media state**
...
- [x] **Step 5: Tambahkan test mode internal dan chat pribadi**
...
- [x] **Step 6: Jalankan test untuk membuktikan kondisi merah**
...
- [x] **Step 1: Tambahkan state dan validasi mode**
...
- [x] **Step 2: Pisahkan identifier chat dari identifier participant**
...
- [x] **Step 3: Bentuk return shape Identity yang tetap**
...
Untuk grup, rawGroupId: cari pada key payload chatId, from, from.id, id.remote, id._serialized, _data.id._serialized, _data.id.remote, _data.Info.Chat, _data.chatId, key.remoteJid, chat.id, chat.id._serialized, groupId, dan group.id yang nilainya @g.us. Jika tidak ditemukan, cari pada TChat.NomorWhatsapp yang bernilai @g.us. Fallback terakhir TChat.IdWahaTerdeteksi atau TChat.NomorWhatsappTerdeteksi. Jangan gunakan participant, author, sender.id, _data.author, atau hasil recursive scan non-grup untuk identitas grup. rawGroupName memakai payload group.subject, group.name, chat.name, atau _data.chat.name bila ada; TChat.NamaGrupWhatsapp hanya fallback. Untuk pribadi, raw contact memakai TChat.NamaKontak/NomorWhatsapp dan payload chat JID.
...
- [x] **Step 4: Tambahkan PayloadJson ke query message dan metadata media**
...
- [x] **Step 5: Pisahkan sender grup pada message row**
...
- [x] **Step 6: Jalankan test Livewire sampai hijau**
...
- [x] **Step 1: Tambahkan assertion render merah sebelum Blade diubah**
...
- [x] **Step 2: Tambahkan key localization id/en**
...
- [x] **Step 3: Tambahkan toggle accessible pada header daftar chat**

Gunakan dua button type=button dengan syntax Livewire eksplisit: `wire:click="$set('identityDisplayMode', 'whatsapp')"` dan `wire:click="$set('identityDisplayMode', 'internal')"`; tambahkan `aria-pressed` berdasarkan state, focus-visible ring, dan label localized. Jangan gunakan Alpine/localStorage. Tempatkan di header daftar chat agar mode berlaku jelas untuk seluruh daftar/header/detail.

- [x] **Step 4: Gunakan proyeksi aktif pada daftar dan header**
...
- [x] **Step 5: Tampilkan sender anggota grup pada bubble masuk**
...
- [x] **Step 6: Tambahkan renderer dan download untuk setiap kategori**
...
- [x] **Step 7: Jalankan test render dan build**
...
- [x] **Step 1: Jalankan targeted tests secara berurutan**
...
- [x] **Step 2: Jalankan syntax dan formatter**
...
- [x] **Step 3: Jalankan full test suite**
...
- [x] **Step 4: Jalankan frontend build**
...
- [x] **Step 7: Sinkronkan checkbox OpenSpec setelah bukti tersedia**
...
- [x] **Step 9: Catat deployment dan rollback**
...
**Catatan validasi akhir 2026-07-29:** Targeted PHPUnit, syntax, Pint, `npm run build`, dan `openspec validate inbox-whatsapp-improvement --strict` lulus. `php artisan test` penuh sudah dijalankan tetapi terblokir sebelum test oleh konfigurasi lokal SQL Server ODBC: `Encryption not supported on the client`. Verifikasi manual nyata dengan WAHA/WhatsApp aktif dan data produksi belum dijalankan di environment ini.
