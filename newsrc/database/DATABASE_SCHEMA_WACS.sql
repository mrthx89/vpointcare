...
CREATE TABLE MUser (
    ...
    status nvarchar(20) NOT NULL CONSTRAINT DF_MUser_status DEFAULT 'approved',
    approved_at datetime2 NULL,
    blocked_at datetime2 NULL,
    created_at datetime2 NULL,
    updated_at datetime2 NULL,
    CONSTRAINT PK_MUser PRIMARY KEY (id),
    CONSTRAINT UQ_MUser_email UNIQUE (email)
);
GO
...
CREATE TABLE MPengguna (
    ...
    CONSTRAINT FK_MPengguna_MUser FOREIGN KEY (UserId) REFERENCES MUser(id),
